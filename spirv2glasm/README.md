...
* **`probes.7z`** — the probes, as one archive: `probes/` (654 shaders that
...
all 654 probes come out byte-identical to `listings/`.
...
#   exact 654  prefix-only 0  DIFFERS 0  failed 0
