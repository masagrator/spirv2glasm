...
* **`probes.7z`** — the probes, as one archive: `probes/` (650 shaders that
...
all 650 probes come out byte-identical to `listings/`.
...
#   exact 650  prefix-only 0  DIFFERS 0  failed 0
