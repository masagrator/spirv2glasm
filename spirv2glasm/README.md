...
* **`probes.7z`** — the probes, as one archive: `probes/` (642 shaders that
...
all 642 probes come out byte-identical to `listings/`.
...
#   exact 642  prefix-only 0  DIFFERS 0  failed 0
