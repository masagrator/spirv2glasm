...
# `control_form` is tools/checklisting.py's -- the relation between a captured
# listing and the fat control section was established there, against the
# compiler's own stored sections, and it is imported rather than restated so
# there is exactly one definition of it.
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                "..", "tools"))
from checklisting import control_form                           # noqa: E402
